...
{{- if and (not .Values.secrets.existingSecret) (or .Values.secrets.otelIngestToken .Values.secrets.adminApiKey .Values.secrets.enterpriseAnalyticsKey .Values.secrets.foundryApiKey .Values.secrets.adminPassword) -}}
true
{{- end }}
{{- end }}
